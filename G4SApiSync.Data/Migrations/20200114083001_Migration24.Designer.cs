...
namespace G4SApiSync.Data.Migrations
{
    ...
    [Migration("20200114083001_Migration24")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("G4SApiSync.Data.Entities.PriorAttainmentType", b =>
                {
                    b.Property<string>("PriorAttainmentTypeId")
                        .HasColumnType("nvarchar(100)")
                        .HasMaxLength(100);
                    ...
                    b.HasKey("PriorAttainmentTypeId");

                    b.ToTable("PriorAttainmentTypes");
                });

            modelBuilder.Entity("G4SApiSync.Data.Entities.PriorAttainmentValue", b =>
                {
                    b.Property<int>("PriorAttainmentValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("PriorAttainmentValueId");

                    b.HasIndex("PriorAttainmentTypeId");

                    b.HasIndex("StudentId");

                    b.ToTable("PriorAttainmentValues");
                });
            ...
            modelBuilder.Entity("G4SApiSync.Data.Entities.PriorAttainmentValue", b =>
                {
                    b.HasOne("G4SApiSync.Data.Entities.PriorAttainmentType", "PriorAttainmentType")
                        .WithMany("PriorAttainmentValues")
                        .HasForeignKey("PriorAttainmentTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
