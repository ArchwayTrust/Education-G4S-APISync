    ...
    public class GETBehClassifications : IEndPoint<BehClassificationDTO>, IDisposable
    {
        ...
        public async Task<bool> UpdateDatabase(string APIKey, string AcYear, string AcademyCode, int? LowestYear = null, int? HighestYear = null, int? ReportId = null, DateTime? Date = null)
        {
            try
            {
                ...
                APIRequest<GETBehClassifications, BehClassificationDTO> getClassification = new APIRequest<GETBehClassifications, BehClassificationDTO>(_endPoint, APIKey, AcYear);
                var behClassificationDTO = getClassification.ToList();
                ...
                foreach (var classificationDTO in behClassificationDTO)
                {
