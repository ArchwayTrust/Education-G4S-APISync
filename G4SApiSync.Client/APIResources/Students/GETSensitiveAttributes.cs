...
{
    [JsonObject]
    public class GETSensitiveAttributes : IEndPoint<AttributeDTO>
    {
                ...
                foreach (var attributeDTO in attributesDTO)
                {
                    ...
                    if (attributeDTO.AttributeValues != null)
                    {
                        foreach (var attValue in attributeDTO.AttributeValues)
                        {
                            ...
                            {
                                AttributeTypeId = AcademyCode + AcYear + "-Sensitive-" + attributeDTO.AttributeId.ToString(),
