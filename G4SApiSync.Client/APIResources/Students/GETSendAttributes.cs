...
namespace G4SApiSync.Client.EndPoints
{
    ...
    public class GETSendAttributes : IEndPoint<AttributeDTO>, IDisposable
    {
        ...
        public GETSendAttributes(G4SContext context, string connectionString)
        {
            _context = context;
        ...
        public async Task<bool> UpdateDatabase(string APIKey, string AcYear, string AcademyCode, int? LowestYear = null, int? HighestYear = null, int? ReportId = null)
        {
            try
            {
                var getAttributes = new APIRequest<GETSendAttributes, AttributeDTO>(_endPoint, APIKey, AcYear);
