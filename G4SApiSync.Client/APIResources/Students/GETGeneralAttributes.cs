...
namespace G4SApiSync.Client.EndPoints
{
    ...
    public class GETGeneralAttributes : IEndPoint<AttributeDTO>, IDisposable
    {
        ...
        public GETGeneralAttributes(G4SContext context, string connectionString)
        {
            _context = context;
        ...
        public async Task<bool> UpdateDatabase(string APIKey, string AcYear, string AcademyCode)
        {
            try
            {
                var getAttributes = new APIRequest<GETGeneralAttributes, AttributeDTO>(_endPoint, APIKey, AcYear);
